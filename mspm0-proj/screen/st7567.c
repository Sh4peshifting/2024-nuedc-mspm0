...
void ST7567_Init(void)
{
    ...
    delay_ms(2)
        ST7567_Reset();
    delay_ms(10);
    ST7567_WriteCommand(0xe2);
    delay_ms(1);
    ST7567_WriteCommand(0xA2);
    ST7567_WriteCommand(0xA0);
    ST7567_WriteCommand(0xC8);
    ST7567_WriteCommand(0x24);
    delay_ms(2);
    ST7567_WriteCommand(0x81);
    ST7567_WriteCommand(0x2B);
    delay_ms(1);
    ST7567_WriteCommand(0x29);
    delay_ms(1);
    ST7567_WriteCommand(0x2B);
    delay_ms(1);
    ST7567_WriteCommand(0x2F);
    delay_ms(1);
    ST7567_WriteCommand(0xAF);
    delay_ms(1);
}
