...
#else
#define ST7567_SCK_LOW DL_GPIO_clearPins(SPI_SDA_PORT, SPI_SDA_PIN)
#define ST7567_SCK_HIGH DL_GPIO_setPins(SPI_SCL_PORT, SPI_SCL_PIN)
#define ST7567_CS_LOW DL_GPIO_clearPins(SPI_CS_PORT, SPI_CS_PIN)
#define ST7567_CS_HIGH DL_GPIO_setPins(SPI_CS_PORT, SPI_CS_PIN)
#define ST7567_MOSI_LOW DL_GPIO_clearPins(SPI_SDA_PORT, SPI_SDA_PIN)
#define ST7567_MOSI_HIGH DL_GPIO_setPins(SPI_SDA_PORT, SPI_SDA_PIN)
#endif
...
#define ST7567_DC_LOW DL_GPIO_clearPins(SPI_CD_PORT, SPI_CD_PIN)
#define ST7567_DC_HIGH DL_GPIO_setPins(SPI_CD_PORT, SPI_CD_PIN)
#define ST7567_RESET_LOW DL_GPIO_clearPins(SPI_RST_PORT, SPI_RST_PIN)
#define ST7567_RESET_HIGH DL_GPIO_setPins(SPI_RST_PORT, SPI_RST_PIN)
